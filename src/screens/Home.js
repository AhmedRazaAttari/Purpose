...
import { FirstSection, NavbarComp, SecondSection, ThirdSection, ThirdSection2, FourthSection, Plans, Features, SixthSection, SevenSection, EightSection } from '../components/index';
...
import { faYelp, faFirefox, faGg } from '@fortawesome/fontawesome-free-brands';
...
export default class Home extends Component {
    ...
    render() {
        return <div style={{ position: "relative" }} id="ForTopScroll">
            ...
            <NavbarComp NavbarLink1={<Nav.Link className="NavLink_Style"><Link to="/"  >Home</Link></Nav.Link>} NavbarLink2={<Nav.Link href="#24MeSection" className="NavLink_Style" >Features</Nav.Link>} NavbarLink3={<Nav.Link href="#PricingPlan" className="NavLink_Style" >Pricing</Nav.Link>} NavbarLink4={<Nav.Link className="NavLink_Style" >Case Studies</Nav.Link>} LoginBtn={<Nav.Link><Link to="/Login" className="LoginBtn_Design2">Login</Link></Nav.Link>} SignupBtn={<Nav.Link><Link to="/signup" style={{ color: "white", padding: 7, borderRadius: 5, border: "1px solid #6e00ff", background: "#6e00ff", paddingLeft: 15, paddingRight: 15, textDecoration: "none" }}>Signup</Link></Nav.Link>} />
